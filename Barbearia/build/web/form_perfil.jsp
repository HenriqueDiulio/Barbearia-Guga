<%-- 
    ...
    Created on : 14/06/2023, 13:32:52
    Author     : Henrique
--%>
...
<html>
    ...
    <body>
        ...
        <div class="card">
            <h5 class="card-header">Cadastre um Perfil abaixo</h5>
        </div>
        <form class="formulario" method="POST" action="gerenciar_perfil.do">
            <label for="inputEmail4">ID</label><br>
            <input type="hidden" class="form-control" name="idPerfil" value="${perfil.idPerfil}">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputEmail4">Nome</label>
                    <input type="text" class="form-control" name="nome" value="${perfil.nome}" required="">
                </div>
            </div>
