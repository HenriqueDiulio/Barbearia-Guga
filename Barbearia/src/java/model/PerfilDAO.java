 ...
 * @author Henrique
 */
// e uma classe que se estende de Data base pois ela faz pesquisas lá
public class PerfilDAO extends DataBaseDAO {
    ...
    public ArrayList<Perfil> getLista()throws Exception{
        ...
        ArrayList<Perfil> lista= new ArrayList<Perfil>(0);
    ...
    public ArrayList<Menu> menusVinculadosPorPerfil(int idPerfil) throws Exception{
        ...
        while(rs.next()){
            ...
            m.setTitulo(rs.getString("m.titulo"));
     ...
     public ArrayList<Menu> menusNaoVinculadosPorPerfil(int idPerfil) throws Exception{
        ...
        ArrayList<Menu> lista = new ArrayList<Menu>();
        String sql = "SELECT m.* FROM menu as m WHERE m.idMenu NOT IN"
                + "(SELECT mp.idMenu FROM menu_perfil as mp WHERE mp.idPerfil=?)";
        this.conectar();
        PreparedStatement pstm = conn.prepareStatement(sql);
        pstm.setInt(1,idPerfil);
        ResultSet rs = pstm.executeQuery();
